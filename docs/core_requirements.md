...
| `<stdint.h>` | <ul><li>`int8_t`</li><li>`int16_t`</li><li>`int32_t`</li><li>`int64_t`</li><li>`uint8_t`</li><li>`uint16_t`</li><li>`uint32_t`</li><li>`uint64_t`</li></ul><li>`uintptr_t`</li> |
...
| `<stdatomic.h>`| <ul><li>`memory_order_relaxed`</li><li>`memory_order_consume`</li><li>`memory_order_acquire`</li><li>`memory_order_release`</li><li>`memory_order_acq_rel`</li><li>`memory_order_seq_cst`</li><li>`atomic_load_explicit`</li><li>`atomic_store_explicit`</li><li>`atomic_fetch_add_explicit`</li><li>`atomic_fetch_sub_explicit`</li><li>`atomic_exchange_explicit`</li></ul> |
...
Core functions (allocation) will be implemented in C.
