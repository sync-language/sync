...
class NumberLiteral {
  public:
    ...
    [[nodiscard]] static std::variant<NumberLiteral, sy::CompileError> create(const sy::StringSlice source,
...
class CharLiteral {
  public:
    [[nodiscard]] static std::variant<CharLiteral, sy::CompileError> create(const sy::StringSlice source,
                                                                            const uint32_t start, const uint32_t end);
...
class StringLiteral {
  public:
    [[nodiscard]] static std::variant<StringLiteral, sy::CompileError>
