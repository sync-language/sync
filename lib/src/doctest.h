...
int Context::run() {
    ...
    std::cerr << "[DEBUG] Starting test loop" << std::endl;
    for (auto& curr : testArray) {
        const auto& tc = *curr;
        std::cerr << "[DEBUG] Test: " << tc.m_name << std::endl;
        ...
        {
            std::cerr << "[DEBUG] EXECUTING: " << tc.m_name << std::endl;
            p->currentTest = &tc;
            ...
            std::cerr << "[DEBUG] test_case_start: " << tc.m_name << std::endl;
            DOCTEST_ITERATE_THROUGH_REPORTERS(test_case_start, tc);
            std::cerr << "[DEBUG] test_case_start done: " << tc.m_name << std::endl;
