...
/// The return of the call will be stored in `outReturnValue`, provided the function does return a
/// value.
Result<void, AnyError> interpreterExecuteScriptFunction(const RawFunction* scriptFunction,
                                                        void* outReturnValue);
} // namespace sy
